...
cv2.createTrackbar("upper_hue","bars",34,180,hello)
cv2.createTrackbar("upper_saturation","bars",134, 255, hello)
cv2.createTrackbar("upper_value","bars",255, 255, hello)
cv2.createTrackbar("lower_hue","bars",28,180, hello)
cv2.createTrackbar("lower_saturation","bars",0, 255, hello)
cv2.createTrackbar("lower_value","bars",239, 255, hello)
...
while(True):
    ...
    # inverse is done as i want to remove that part.
...
# here mask  will used so that we get image  that of the color given and the given color get removed.
...
# this will give us that black area of the particular mask color
